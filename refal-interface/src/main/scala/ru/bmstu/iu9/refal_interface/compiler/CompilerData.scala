package ru.bmstu.iu9.refal_interface.compiler
...
class CompilerData {
  import ru.bmstu.iu9.refal_interface.compiler.CompilerData._
  import ru.bmstu.iu9.refal_interface.lexer.Scanner
  import ru.bmstu.iu9.refal_interface.lexer.Token.Position
