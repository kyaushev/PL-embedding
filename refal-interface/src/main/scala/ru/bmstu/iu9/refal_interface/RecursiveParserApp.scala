...
import ru.bmstu.iu9.refal_interface.generator.InputGenerator
import ru.bmstu.iu9.refal_interface.parser.Parser
import ru.bmstu.iu9.refal_interface.parser.Tree.Node

import java.io._
import scala.reflect.io.Directory
import scala.util.Try

object RecursiveParserApp {
  val dir = "output"
  val task_dir = "tasks"
  val error = "error.txt"
  val tree = "tree.txt"
